...
async function fetchtoken(){
      try {
          await axios.post("http://localhost:8000/generate_token", {
            username: username.value
        })
        .then((response) => {
          console.log('YAYYYYYYYYYY',response.data);
...
// define user's Token Here


// define callee's commuication ID Here
//เบอร์โทร
//ID พี่พีนัท
let calleeCommuID = document.getElementById('selected-id');
